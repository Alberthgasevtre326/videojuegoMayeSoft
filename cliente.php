                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="acerca_de.php">about</a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="nav-link" href="servicio.php">services</a>
                                 </li>
                                 <li class="nav-item">
                                    <a class="nav-link" href="equipo.php">team </a>
                                 </li>
                                 <li class="nav-item active">
                                    <a class="nav-link" href="cliente.php">Clients</a>
                                 </li>
                                 <li class="nav-item">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-2 col-md-6 col-sm-6">
                     ...
                     <ul class="link_icon">
                        ...
                        <li class="active"> <a href="client.html"></i>Clients</a></li>
