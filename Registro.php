               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-6 col-sm-6">
                        <ul class="lan">
                           <li><i class="fa fa-globe" aria-hidden="true"></i> Lenguaje : <img src="images/fleg.png" alt="#"/></li>
                        </ul>
                        <form action="#" >
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-5 d_none">
                        <ul class="sign">
                           ...
                           <li><a class="sign_btn" href="#">Regístrate</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-8 offset-md-2">
                  ...
                  <form action="" method="POST" class="contact_form">
                     ...
                     <div class="row">
                        <div class="col-md-12 ">
                           <input class="contact_control" placeholder="Nombre" type="type" name="Nombre" require> 
                        </div>
                        <div class="col-md-12 ">
                           <input class="contact_control" placeholder="Apellido" type="type" name="Apellido" required> 
                        </div>
                        <div class="col-md-12">
                           <input class="contact_control" placeholder="Correo" type="type" name="Email" required> 
                        </div>
                        <div class="col-md-12">
                           <input class="contact_control" placeholder="Usuario" type="type" name="usuario" required> 
                        </div>
                        <div class="col-md-12 ">
                           <input class="contact_control" placeholder="Password" type="password" name="Clave" minlength="20"> 
                        </div>
                        <div class="col-md-12">
                           <!--<button class="send_btn" type="submit" name="registro">Enviar</button>-->
                           <!--<button class="send_btn" type="submit" name="registro">Enviar</button>-->
                           <button class="send_btn" type="submit" value="Registrar" name="registro">Registrar</button>
                        </div>
                  </form>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-2 col-md-6 col-sm-6">
                     ...
                     <ul class="link_icon">
                        ...
                        <li> <a href="clients.html"></i>Clients</a></li>
